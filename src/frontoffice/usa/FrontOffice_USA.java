...
import static frontoffice.base.DBConnection.stmt;
...
public class FrontOffice_USA extends DBConnection implements ActionListener, FocusListener {
    ...
    void render() {
        ...
        JLabel detailsMLbl = new JLabel("sjfhsjkdfhkjsdhfj");
        detailsPnl.add(detailsMLbl);
        detailsMLbl.setFont(h1);
    ...
    private void loadRights(String userid) {
        if( userid.equals("")) {
        ...
        try {
            ...
            if ( Settings.get("username") == null ) {
                ...
                if ( Settings.get("saleswindow") == null ) {
                    ...
                    loadRights(Settings.get("userid").toString());
                    allow = true;
                }
            }
        } catch ( Exception a ) {
    ...
    public static void main(String[] args) {
        FrontOffice_USA fo = new FrontOffice_USA();
        fo.render();
    }
